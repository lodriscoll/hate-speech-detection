...
def main():
    ...
    parser.add_argument('--model', '-m', type=str, default='AlwaysPredictZero',
                        choices=['AlwaysPredictZero', 'NaiveBayes', 'LogisticRegression', 'L2Reg', 'BonusClassifier'])
    ...
    if args.model == "AlwaysPredictZero":
        ...
        model = LogisticRegressionClassifier(lr=args.lr, epochs=args.epochs)
    elif args.model == "L2Reg":
        model = L2RegLogisticRegressionClassifier(lr=args.lr, epochs=args.epochs, lam=args.lam)
